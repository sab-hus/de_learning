...
from file_names_config import file_for_clustering_load, table_id_json_clustering_load, schema
import io
import logging
...
clustering_fields = ["Destination", "Date"]
...
if __name__ == "__main__":
    ...
    file_path = file_for_clustering_load
    table_id = table_id_json_clustering_load
